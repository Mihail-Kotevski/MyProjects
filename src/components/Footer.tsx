      ...
      <div className="wrapper">
        <div className="content">
          ...
          <div className="social">
            <a href="https://www.facebook.com/mixail.kotevski/" target="blank">
              <svg
            ...
            <a href="https://www.instagram.com/mihail.kotevski/" target="blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 48 48"
                width="48px"
            ...
            <a
              href="https://www.linkedin.com/in/mihail-kotevski-733033279/"
              target="blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              href="https://github.com/Mihail-Kotevski/MyProjects/branches"
              target="blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="page-info">
          <span>Designed and coded by Mihail Kotevski | 2024 ©</span>
        </div>
      </div>
    </div>
  );
